...
Agent 4 Step 1 (事实核查) → **Step 1.5 (Absolute Negative Claim Detection)** → Step 2 (逻辑审查)
...
```markdown
- **Absolute Negative Claim Detection** (Step 1.5): N absolute negative claims detected
