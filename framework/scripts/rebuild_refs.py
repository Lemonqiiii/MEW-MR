...
if '--help' in _sys.argv or '-h' in _sys.argv:
    print("Usage: python3 rebuild_refs.py")
    print("  Rebuild manuscript with consistently formatted references.")
    print("  Reads manuscript from config.yaml paths.manuscript_src.")
    _sys.exit(0)
