# Postnatal Corticosteroids for Preterm Infants: Neurodevelopmental Outcomes and the Evolving Dexamethasone–Hydrocortisone Evidence Base
...
**Objective:** To synthesize evidence from randomized controlled trials (RCTs), systematic reviews, and observational studies on the association between postnatal systemic corticosteroids — dexamethasone and hydrocortisone — and long-term neurodevelopmental outcomes in preterm infants.
...
### 2.1 The Dexamethasone Era

Systemic corticosteroids entered neonatal practice in the 1980s, driven by recognition of lung inflammation as a central driver of BPD [4, 5]. Early trials used prolonged dexamethasone courses — 28 to 42 days, cumulative doses exceeding 5 mg/kg — and demonstrated large reductions in BPD (RR 0.76, NNT ~10), facilitating extubation and shortening ventilation [6]. Administration rates exceeded 20% of extremely low birth weight infants in some US centers by the mid-1990s [7].
...
In 2002, the AAP Committee on Fetus and Newborn stated: "Routine use of systemic dexamethasone for the prevention or treatment of chronic lung disease in infants with very low birth weight is not recommended" [3]. Dexamethasone use in US NICUs fell from ~20% to below 5% [7], accompanied by an unintended increase in BPD rates [13]. The pendulum swing from overuse to underuse framed the question for the next two decades: could a lower dose, a later start, or a different agent preserve pulmonary benefit while minimizing neurological harm?

---

## 3. The Cochrane Evidence: Timing and Agent

The evidence base assembled over the two decades following the AAP statement provides partial answers to the questions it raised. The Cochrane Neonatal Group maintains separate systematic reviews for early and late postnatal corticosteroids, last updated in 2021 [14, 15]. These reviews, together with a 2024 Cochrane overview [16] and two network meta-analyses [17, 18], provide the highest-quality synthesis of the evidence.

### 3.1 Early Corticosteroids (<7 Days)

The 2021 Cochrane review included 32 RCTs (4,395 infants) [14]. Early corticosteroids reduced BPD (RR 0.76, 95% CI 0.67–0.86; NNT ~10) and death or BPD (RR 0.87, 95% CI 0.79–0.95), but increased cerebral palsy (RR 1.42, 95% CI 1.08–1.87; NNH ~20; high-certainty GRADE). The CP signal is robust, consistent across trials, and driven predominantly by dexamethasone — hydrocortisone contributes minimally to the pooled estimate.

### 3.2 Late Corticosteroids (≥7 Days)

The late corticosteroid review included 23 RCTs (1,817 infants) [15]. Late administration reduced BPD (RR 0.80, 95% CI 0.70–0.91; NNT ~13) and death or BPD (RR 0.83, 95% CI 0.73–0.94), with attenuated CP risk (RR 1.12, 95% CI 0.81–1.54). Mortality was reduced (RR 0.81, 95% CI 0.66–0.99; high-certainty GRADE), a finding absent from the early review.

### 3.3 The Dose Dimension

A variable that cuts across the timing-agent taxonomy is cumulative dose. Early dexamethasone trials used >5 mg/kg; subsequent trials using far lower exposures found reassuring neurodevelopmental profiles, as detailed in Section 4 and 5. The 2021 network meta-analysis of 14 corticosteroid regimens [18] found that moderately-early, low-dose dexamethasone (MoLdDX) and late low-dose hydrocortisone optimized the risk-benefit balance, while early high-dose dexamethasone had the least favorable profile. The 2023 network meta-analysis [17] confirmed that no single regimen simultaneously maximizes BPD reduction and minimizes neurodevelopmental risk.

### 3.4 Dexamethasone versus Hydrocortisone

No adequately powered head-to-head trial exists. Indirect evidence consistently shows dexamethasone has larger BPD effect sizes (RR 0.72) than hydrocortisone (RR 0.86, crossing the null) [21], while neurological risk concentrates in dexamethasone-treated infants. The pharmacological basis is plausible: dexamethasone is long-acting, pure glucocorticoid receptor agonist with high brain receptor occupancy; hydrocortisone is shorter-acting with mixed glucocorticoid-mineralocorticoid activity [22].

---

## 4. The Dexamethasone Evidence in Detail

### 4.1 Landmark Trials

The early dexamethasone CP signal (Section 2.2) derived from trials using prolonged, high-dose courses. The DART trial (2007) tested whether a low-dose, 10-day regimen (0.89 mg/kg) after the first week could avoid neurotoxicity [19]. Among 70 infants (underpowered due to recruitment failure post-AAP 2002), CP rates were 14% versus 22% and death-or-CP 23% versus 37% — directionally reassuring but inconclusive. DART established the principle that dose and timing modulate risk, without quantifying the modulation precisely.

### 4.2 Beyond Cerebral Palsy

A 2014 meta-analysis of dexamethasone RCTs [23] found adverse effects on intelligence and hearing. A 2025 cohort study showed that low-dose postnatal dexamethasone was associated with altered regional brain volumes on term-equivalent MRI [24] — suggesting that even "low-dose" dexamethasone may have measurable structural brain effects, though the functional significance of these volume differences is unclear.

---

## 5. Hydrocortisone: The Emerging Evidence

### 5.1 PREMILOC: Prophylactic Low-Dose Hydrocortisone

PREMILOC randomized 523 infants (24–27 weeks) to prophylactic hydrocortisone (1 mg/kg/day × 7d, then 0.5 mg/kg/day × 3d) or placebo within 24 hours of birth [20]. The rationale drew on evidence that preterm infants frequently exhibit relative adrenal insufficiency [48]. Hydrocortisone increased BPD-free survival (60% vs. 51%; OR 1.48, 95% CI 1.02–2.16; NNT = 12). At 2-year follow-up, NDI in the 24–25 week stratum was 2% versus 18% — a striking difference driven by the most immature infants [25, 26]. Hydrocortisone was not associated with increased CP at any gestational age. Post-hoc analyses (2024) refined the treatment effect (adjusted OR 2.05; NNT = 5.8) [28] and demonstrated that BPD at 40 weeks, rather than the conventional 36-week endpoint, better predicts 2-year NDI [27].

**Significance:** PREMILOC provided the first RCT evidence that early hydrocortisone does not share dexamethasone's neurotoxic profile. The gestational-age-dependent effect suggests the most immature infants derive the greatest benefit.

### 5.2 SToP-BPD: Late Higher-Dose Hydrocortisone
...
The NICHD NRN trial randomized 799 infants (<30 weeks, ventilated ≥7 days) to a 10-day hydrocortisone course (14–28 days) or placebo [34]. Hydrocortisone neither reduced BPD-or-death (40.8% vs. 40.4%) nor increased NDI-or-death (38.1% vs. 37.9%). A secondary analysis found no significant interaction between baseline BPD risk and treatment effect [35].

**School-age follow-up (2026).** The NICHD NRN school-age follow-up [36] — the second of the two 2026 publications — evaluated functional motor, cognitive, academic, and pulmonary outcomes at early school age in the HC trial cohort. Together with the SToP-BPD 5.5-year data, these represent the first RCT-derived school-age evidence for any postnatal corticosteroid beyond the Yeh dexamethasone cohort, and the first for hydrocortisone.

### 5.4 Hydrocortisone Dose and Long-Term Neurodevelopment

A 2026 Japanese cohort study [37] of extremely low birth weight infants found that total hydrocortisone dosage was associated with neurodevelopmental outcomes up to school age, suggesting a dose-response relationship that parallels the dexamethasone dose-toxicity gradient. Even within the "safer" hydrocortisone category, cumulative dose matters.
...
NEUROSIS randomized 863 infants (23–27 weeks) to early inhaled budesonide or placebo [38]. Budesonide reduced BPD (RR 0.74, 95% CI 0.60–0.91; NNT ~14), but a post-hoc analysis revealed increased mortality (18.9% vs. 14.4%; RR 1.37, 95% CI 1.01–1.86; NNH ~18). The 5-year follow-up [39] found that among survivors, budesonide was associated with higher moderate-to-severe NDI (16.9% vs. 12.0%; RR 1.41, 95% CI 1.01–1.96). The composite of death or neurodevelopmental disability significantly favored placebo — a rare example in neonatology of a therapy improving the short-term endpoint while worsening the outcomes that matter most.

### 6.2 Budesonide–Surfactant Combinations

Recent systematic reviews [40, 41] have evaluated intratracheal budesonide combined with surfactant. While short-term BPD reductions have been reported, long-term neurodevelopmental data are absent. This approach remains investigational.

---

## 7. Neurodevelopmental Outcomes: A Synthesis

### 7.1 The Measurement Problem

The overwhelming majority of postnatal corticosteroid trials assess neurodevelopment using the Bayley Scales at 18–24 months. Sensitivity and specificity of Bayley-III <85 for predicting school-age IQ <85 are approximately 50–60% and 70–80% [42]. A normal Bayley at 2 years provides only modest reassurance about cognitive function at 8 years — a limitation that cuts to the core of the uncertainty surrounding these therapies.

### 7.2 Cerebral Palsy: A Clear Gradient

The Cochrane data establish a consistent gradient: early dexamethasone increases CP (high-certainty GRADE); late dexamethasone's signal is attenuated (CI crosses null but does not exclude harm); hydrocortisone has not been associated with statistically increased CP in any trial or meta-analysis [14, 15]. Baseline CP risk matters: in the Cochrane populations (~15–20%), the absolute increase from early dexamethasone was ~5 percentage points (NNH ~20); in contemporary NICUs where CP rates have declined to 8–12%, proportional harm may be lower.

### 7.3 School-Age Cognition

The Yeh 2004 school-age follow-up [10] and the Jenkinson 2023 systematic review [12] document IQ deficits of 5–7 points in dexamethasone-exposed children — a population-level shift with meaningful individual consequences. These observational data are subject to confounding by indication. The critical advance is the 2026 publication of school-age follow-up data from two hydrocortisone RCTs [33, 36] — the first controlled evidence beyond 2 years for any postnatal corticosteroid other than the single dexamethasone cohort reported by Yeh et al. [10].

### 7.4 Behavior and Executive Function

Beyond cognition, the evidence is sparse. SToP-BPD reported lower anxiety scores in HC-treated children at 2 years [30]. No RCT has reported executive function, social competence, or mental health outcomes in middle childhood or adolescence for any postnatal corticosteroid — these are the outcomes most relevant to quality of life and remain unmeasured.

### 7.5 BPD as a Mediator

BPD is both a treatment target and an independent risk factor for NDI (2- to 3-fold increased odds of CP, cognitive delay, and behavioral problems) [43]. Corticosteroids may exert indirect neuroprotection through BPD reduction that partially offsets direct neurotoxicity. The EPICE cohort study [44] provided the first direct test of this hypothesis: it compared neurodevelopment in PNS-treated versus untreated infants stratified by predicted BPD risk, finding that the risk-benefit balance may indeed depend on baseline risk — beneficial in the highest-risk infants, harmful in lower-risk infants. The NICHD NRN secondary analysis [35] tested but did not confirm this interaction, though the trial's null primary result limited power.
...
The 2025 European RDS Consensus Guidelines [45] recommend: avoid routine early dexamethasone (A2); consider low-dose dexamethasone after 1–2 weeks of ventilation in infants at >60% BPD risk (A2); hydrocortisone as an alternative with less-established BPD efficacy; and no routine inhaled corticosteroids outside research.

### 8.2 A Risk-Stratified Approach

The evidence supports stratification by postnatal age, BPD risk, and agent:
...
The hypothesis that BPD risk modifies the neurodevelopmental effect of corticosteroids is supported by EPICE cohort data [44] but not confirmed by RCT-level analysis. A trial stratifying enrollment by predicted BPD risk and powered to detect interaction effects (N > 1,000) would resolve this question.
...
8. Shinwell ES, Karplus M, Reich D, et al. Early postnatal dexamethasone therapy and increased incidence of cerebral palsy. *Arch Dis Child Fetal Neonatal Ed* 1997;76:F283–7.
...
14. Doyle LW, Cheong JL, Hay S, et al. Early (<7 days) systemic postnatal corticosteroids for prevention of bronchopulmonary dysplasia in preterm infants. *Cochrane Database Syst Rev* 2021;(10):CD001146.
...
16. van de Loo M, van Kaam A, Offringa M, et al. Corticosteroids for the prevention and treatment of bronchopulmonary dysplasia: an overview of systematic reviews. *Cochrane Database Syst Rev* 2024;(3):CD013271. PMID: 38597338.
...
37. Taniguchi A, et al. Total hydrocortisone dosage in extremely low birth weight infants and neurodevelopment up to school age. *Pediatr Res* 2026. PMID: 40987824.
38. Bassler D, Plavka R, Shinwell ES, et al. Early inhaled budesonide for the prevention of bronchopulmonary dysplasia. *N Engl J Med* 2015;373:1497–506.
39. Bassler D, Shinwell ES, Hallman M, et al. Long-term effects of inhaled budesonide for bronchopulmonary dysplasia. *N Engl J Med* 2018;378:148–57.
40. Moschino L, et al. Efficacy of pulmonary surfactant with budesonide in premature infants: a systematic review and meta-analysis. *Pediatr Pulmonol* 2025;60:e27488. PMID: 39787118.
41. Filippone M, et al. Use of budesonide associated with a pulmonary surfactant to prevent bronchopulmonary dysplasia in premature newborns. *J Pediatr* 2023. PMID: 36436670.
...
44. Zayat N, Truffert P, Drumez E, et al. Systemic steroids in preventing bronchopulmonary dysplasia: neurodevelopmental outcome according to the risk of BPD in the EPICE cohort. *Arch Dis Child Fetal Neonatal Ed* 2022. PMID: 35564997.
